...
public class BikesNikitskaya {
   ...
   public BikesNikitskaya(){
    ...
    @FXML
    void initialize() {
        assert btn1HourAddict != null : "fx:id=\"btn1HourAddict\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        assert btn1HourAltair != null : "fx:id=\"btn1HourAltair\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        assert btn1HourFormat != null : "fx:id=\"btn1HourFormat\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        assert btn1HourMaxit != null : "fx:id=\"btn1HourMaxit\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        assert btn1HourTwister != null : "fx:id=\"btn1HourTwister\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        assert btn1HourWelt != null : "fx:id=\"btn1HourWelt\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        ...
        assert btn3HourAddict != null : "fx:id=\"btn3HourAddict\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        assert btn3HourAltair != null : "fx:id=\"btn3HourAltair\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        assert btn3HourFormat != null : "fx:id=\"btn3HourFormat\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        assert btn3HourMaxit != null : "fx:id=\"btn3HourMaxit\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        assert btn3HourTwister != null : "fx:id=\"btn3HourTwister\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
        assert btn3HourWelt != null : "fx:id=\"btn3HourWelt\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
...
//    }
//
//    private void enableTimeButtons(boolean enable, RadioButton btn1Hour, RadioButton btn3Hour, RadioButton btn1Week) {
//        btn1Hour.setDisable(!enable);
//        btn3Hour.setDisable(!enable);
//        btn1Week.setDisable(!enable);
//    }
//
//    @FXML
//    void initialize() {
...
//        assert errorTextWelt != null : "fx:id=\"errorTextWelt\" was not injected: check your FXML file 'bikes_nikitskaya.fxml'.";
//
//        enableTimeButtons(false, btn1HourAddict, btn3HourAddict, btn1WeekAddict);
//        enableTimeButtons(false, btn1HourAltair, btn3HourAltair, btn1WeekAltair);
//        enableTimeButtons(false, btn1HourFormat, btn3HourFormat, btn1WeekFormat);
//        enableTimeButtons(false, btn1HourMaxit, btn3HourMaxit, btn1WeekMaxit);
//        enableTimeButtons(false, btn1HourTwister, btn3HourTwister, btn1WeekTwister);
//        enableTimeButtons(false, btn1HourWelt, btn3HourWelt, btn1WeekWelt);
//
//        btnAddict.setOnAction(e -> enableTimeButtons(btnAddict.isSelected(), btn1HourAddict, btn3HourAddict, btn1WeekAddict));
//        btnAltair.setOnAction(e -> enableTimeButtons(btnAltair.isSelected(), btn1HourAltair, btn3HourAltair, btn1WeekAltair));
//        btnFormat.setOnAction(e -> enableTimeButtons(btnFormat.isSelected(), btn1HourFormat, btn3HourFormat, btn1WeekFormat));
//        btnMaxit.setOnAction(e -> enableTimeButtons(btnMaxit.isSelected(), btn1HourMaxit, btn3HourMaxit, btn1WeekMaxit));
//        btnTwister.setOnAction(e -> enableTimeButtons(btnTwister.isSelected(), btn1HourTwister, btn3HourTwister, btn1WeekTwister));
//        btnWelt.setOnAction(e -> enableTimeButtons(btnWelt.isSelected(), btn1HourWelt, btn3HourWelt, btn1WeekWelt));
//    }
//}
