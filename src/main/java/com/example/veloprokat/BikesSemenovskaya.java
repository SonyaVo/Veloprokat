...
public class BikesSemenovskaya {
    ...
    void initialize() {
        ...
        assert countAddict != null : "fx:id=\"countAddict\" was not injected: check your FXML file 'bikes_semenovskaya.fxml'.";
        assert countAltair != null : "fx:id=\"countAltair\" was not injected: check your FXML file 'bikes_semenovskaya.fxml'.";
        assert countFormat != null : "fx:id=\"countFormat\" was not injected: check your FXML file 'bikes_semenovskaya.fxml'.";
        assert countMaxit != null : "fx:id=\"countMaxit\" was not injected: check your FXML file 'bikes_semenovskaya.fxml'.";
        assert countTWISTER != null : "fx:id=\"countTWISTER\" was not injected: check your FXML file 'bikes_semenovskaya.fxml'.";
        assert countWelt != null : "fx:id=\"countWelt\" was not injected: check your FXML file 'bikes_semenovskaya.fxml'.";
        ...
        assert profile != null : "fx:id=\"profile\" was not injected: check your FXML file 'bikes_semenovskaya.fxml'.";
